    ...
    public class AutoMapperProfile:Profile
    {
        public AutoMapperProfile()
        {
            ...
            CreateMap<Usuario, UsuarioDTO>()
                ...
                opt => opt.MapFrom(origen => origen.IdRolNavigation.Nombre)//obtener info desde Nombe hacia rol descption
                )
                .ForMember(destino => destino.EsActivo,
                opt => opt.MapFrom(origen => origen.EsActivo == true ? 1 : 0));//Obtener info viceversa
            ...
            CreateMap<DetalleVenta, DetalleVentaDTO>()
                ...
                opt => opt.MapFrom(origen => origen.IdProductoNavigation.Nombre)//obtener info desde Nombe hacia rol descption
                )
                 .ForMember(destino =>
                destino.PrecioTexto,
                opt => opt.MapFrom(origen => Convert.ToString(origen.Precio.Value, new CultureInfo("es-NI")))//obtener info desde Nombe hacia rol descption
                )
                 .ForMember(destino =>
                destino.TotalTexto,
                opt => opt.MapFrom(origen => Convert.ToString(origen.Total.Value, new CultureInfo("es-NI")))//obtener info desde Nombe hacia rol descption
                );
            ...
            .ForMember(destino =>
             ...
             .ForMember(destino =>
                destino.TotalVenta,
                opt => opt.MapFrom(origen => Convert.ToString(origen.IdVentaNavigation.Total.Value, new CultureInfo("es-NI")))//obtener info desde Nombe hacia rol descption
                )
              .ForMember(destino =>
               destino.Producto,
